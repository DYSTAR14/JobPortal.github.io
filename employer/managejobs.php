...
<?php
$query=mysqli_query($conn,"select * from ads where eid = $eid");
...
<div class="container" id="viewmain">
    ...
    while($result=mysqli_fetch_array($query)){
        ...
        //echo "<td>  <a style='color: whitesmoke;'  href='view.php?jid=".$result['aid']."'><button type='button' class='btn btn-success'>View Job</button></a> </td>";
        echo "<td> <a style='color: whitesmoke;'  href='manage_applicants.php?jobid=".$result['aid']."'><button type='button' class='btn btn-success'> View Applicants</button> </a></td>";
        echo "</tr>";
    }
?>
    </table>
